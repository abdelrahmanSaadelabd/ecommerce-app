...
class CustomDialogsingup extends StatefulWidget {
  ...
  @override
  State<CustomDialogsingup> createState() => _CustomDialogsingupState();
}

class _CustomDialogsingupState extends State<CustomDialogsingup> {
  Timer? _timer;
      ...
      actions: [
        Column(
          children: [
            ...
            GetBuilder<CheckcodesingupController>(
              builder:
