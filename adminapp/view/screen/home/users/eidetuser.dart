...
import 'package:adminapp/controller/user/eidetusercontroller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Eidetuser extends StatelessWidget {
  const Eidetuser({super.key});
        ...
        builder: (context, constraints) {
          return SafeArea(
            child: Container(
              ...
              child: GetBuilder<Eidetusercontroller>(
                init: Eidetusercontroller(),
                builder:
