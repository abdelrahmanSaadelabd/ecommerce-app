...
class Delivers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> images = [APPimage.deluvers, APPimage.approve];
    List<String> namepage = ["/deliversapproved", "/aprovedelivery"];
    List<String> imageNames = ["Delivers", "Approve Delivers"];
              ...
              child: Padding(
                ...
                child: GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: (width / 140).floor().clamp(
                      2,
                      5,
                    ), // responsive
                    crossAxisSpacing: 10,
