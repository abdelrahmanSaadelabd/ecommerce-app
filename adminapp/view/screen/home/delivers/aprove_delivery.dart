...
import 'package:adminapp/controller/deliverycontroller/aprovedeliverycontroller.dart';
import 'package:adminapp/linkapi/link_api.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AproveDelivery extends StatelessWidget {
  const AproveDelivery({super.key});
      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          body: Container(
            ...
            child: GetBuilder<Aprovedeliverycontroller>(
              init: Aprovedeliverycontroller(),
              builder:
