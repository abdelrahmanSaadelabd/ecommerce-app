...
import 'package:adminapp/controller/homecontroller/settingcontroller.dart';
import 'package:adminapp/linkapi/link_api.dart';
import 'package:adminapp/view/screen/home/setting/profilescreen.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                  ...
                  child: Container(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: NetworkImage(
                        "${appLink.imagenprofile}/${myServices.sharedPreferences.getString("adminimage")}",
                      ),
                    ),
                  ),
                ),
              ...
              SizedBox(height: 12),
              Text(
                "${myServices.sharedPreferences.getString("adminname")}",
                style: TextStyle(
